...
// function preview2 (template, data) {
//   let tableData = []
//   let realData = []
      ...
      data.map((item, index) => {
        ...
        for (let sizeIndex = 0; sizeIndex < template.skus[item.size].length; sizeIndex++) {
          ...
          let child = {
            ...
            quantity: template.quantity[template.skus[item.size][sizeIndex]],
            merchant_shipping_group_name: template.merchant_shipping_group_name[site],
            ...
            bullet_point1: template.bullet_points.bullet_point1[site === 'jp' ? 1 : 0].replace('{overallsize_text}', template.overallsize_text[template.skus[item.size][sizeIndex]]),
            bullet_point2: template.bullet_points.bullet_point2[site === 'jp' ? 1 : 0].replace('{overallsize_text}', template.overallsize_text[template.skus[item.size][sizeIndex]]),
            bullet_point3: template.bullet_points.bullet_point3[site === 'jp' ? 1 : 0].replace('{overallsize_text}', template.overallsize_text[template.skus[item.size][sizeIndex]]),
            bullet_point4: template.bullet_points.bullet_point4[site === 'jp' ? 1 : 0].replace('{overallsize_text}', template.overallsize_text[template.skus[item.size][sizeIndex]]),
            bullet_point5: template.bullet_points.bullet_point5[site === 'jp' ? 1 : 0].replace('{overallsize_text}', template.overallsize_text[template.skus[item.size][sizeIndex]]),
            ...
            list_price: getStringOrEmpty(template.list_price[template.skus[item.size][sizeIndex]]),
            uvp_list_price: getStringOrEmpty(template.list_price[template.skus[item.size][sizeIndex]]),
            ...
            display_dimensions_unit_of_measure: getStringOrEmpty(template.display_dimensions_unit_of_measure[site])
