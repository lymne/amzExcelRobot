      ...
      for (let colorIndex = 0; colorIndex < template.colors.length; colorIndex++) {
        ...
        let child = {
          ...
          item_name: template.variation_name[site]
            ...
            .replace('{COLOR_TEXT}', template.color_text[template.colors[colorIndex]][site === 'jp' ? 1 : 0]),
          manufacturer: template.manufacturer[site],
          part_number: tempChildSku,
          standard_price: template.standard_price[site][template.skus[item.size][sizeIndex]],
          quantity: template.quantity[template.skus[item.size][sizeIndex]],
          merchant_shipping_group_name: template.merchant_shipping_group_name[site][template.skus[item.size][sizeIndex]],
          main_image_url: template.main_image_url[template.skus[item.size][sizeIndex]].replace('{CHAR}', `${item.codePrefix}`).replace('{SKU}', `${item.code}`),
          other_image_url1: template.other_image_urls[template.skus[item.size][sizeIndex]][0] ? template.other_image_urls[template.skus[item.size][sizeIndex]][0].replace('{CHAR}', `${item.codePrefix}`).replace('{SKU}', `${item.code}`) : '',
          other_image_url2: template.other_image_urls[template.skus[item.size][sizeIndex]][1] ? template.other_image_urls[template.skus[item.size][sizeIndex]][1].replace('{CHAR}', `${item.codePrefix}`).replace('{SKU}', `${item.code}`) : '',
          other_image_url3: template.other_image_urls[template.skus[item.size][sizeIndex]][2] ? template.other_image_urls[template.skus[item.size][sizeIndex]][2].replace('{CHAR}', `${item.codePrefix}`).replace('{SKU}', `${item.code}`) : '',
          other_image_url4: template.other_image_urls[template.skus[item.size][sizeIndex]][3] ? template.other_image_urls[template.skus[item.size][sizeIndex]][3].replace('{CHAR}', `${item.codePrefix}`).replace('{SKU}', `${item.code}`) : '',
          other_image_url5: template.other_image_urls[template.skus[item.size][sizeIndex]][4] ? template.other_image_urls[template.skus[item.size][sizeIndex]][4].replace('{CHAR}', `${item.codePrefix}`).replace('{SKU}', `${item.code}`) : '',
          other_image_url6: template.other_image_urls[template.skus[item.size][sizeIndex]][5] ? template.other_image_urls[template.skus[item.size][sizeIndex]][5].replace('{CHAR}', `${item.codePrefix}`).replace('{SKU}', `${item.code}`) : '',
          other_image_url7: template.other_image_urls[template.skus[item.size][sizeIndex]][6] ? template.other_image_urls[template.skus[item.size][sizeIndex]][6].replace('{CHAR}', `${item.codePrefix}`).replace('{SKU}', `${item.code}`) : '',
          other_image_url8: template.other_image_urls[template.skus[item.size][sizeIndex]][7] ? template.other_image_urls[template.skus[item.size][sizeIndex]][7].replace('{CHAR}', `${item.codePrefix}`).replace('{SKU}', `${item.code}`) : '',
          parent_child: 'child',
          parent_sku: parent.item_sku,
          relationship_type: 'Variation',
          variation_theme: template.variation_theme[site],
...
function handleShopify (template, data, site) {
